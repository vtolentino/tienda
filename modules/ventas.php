                            ...
                            <div class="content">
                                ...
                                <div>
                                    <div class="row" >
                                        ...
                                        <div class="col-md-6">
                                            <button id="pagar" onclick="pagar()" class="btn btn-secondary btn-fill pull-right">PAGAR</button>
                                        </div>
                                    </div>
                                </div>
                            </div>                                                
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    while($fila = $resultado->fetch_array()){
                                        if ($fila['tipo']==1) {
                                            ...
                                            $suma_reembolso=$suma_reembolso+$fila['precio'];   
                                        }
                                    }
                                    $conexion->close();
                                    ?>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="Tota_modal" style="display: none;" class="form-control" value="" disabled>
                                        <a id="cantidad_total_pagar"></a>
                                        <!-- <h2>41</h2> -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Recibi</label>
                                        <input style="text-align: -webkit-center;" type="number" id="recibo" autofocus  name="recibo" class="form-control" value="" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="content">
                            <div class="row" >
                                <div class="col-md-6">
                                    <button onclick="cerrar()" class="btn btn-secondary btn-fill pull">Cerrar</button>
                                </div>
                                <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function pagar() {
        ...
        $("#Tota_modal").val(sum)
        $("#cantidad_total_pagar").html('<h2 style="margin-block: auto;">'+sum+'</h2>');
    ...
    function terminar() {
        ...
        if($("#recibo").val()==""){
            alert('Favor de introducir cantidad recibida')
            document.getElementById("recibo").focus();
            return
        }
        if(parseInt($("#recibo").val()) < parseInt($("#Tota_modal").val())){
            alert('La cantidad recibida no puede ser menos que el monto total')
            document.getElementById("recibo").focus();
            return
        }
        cambio=parseInt($("#recibo").val())-parseInt($("#Tota_modal").val())
        var tabla = JSON.parse(localStorage.getItem("tabla"));
        $.ajax({
            type: "POST",
            url: 'ventas/ventaFinal.php',
            data: {datos:tabla},
            dataType: "json"
        })
        .done(function(response){
            document.getElementById("pagar").disabled=false;
            alert('Cambio del cliente '+ cambio);
            $('#myModal').css("display", "");
            limpiar()
        })
    }
    ...
    function Agregar_productos() {
        ...
        if($("#id_productos_venta_individual").val()!=""){
            ...
            var id=$("#id_productos_venta_individual").val()
        }
        if(id!=""){
            $.ajax({
                type: "POST",
    ...
    function total(){
        ...
        html="<div class='alert alert-danger pull-right'><span>$"+sum+"</span></div><div class='alert alert-danger pull-right'><span>Total de Compra</span></div>"
